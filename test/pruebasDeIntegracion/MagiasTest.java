...
public class MagiasTest {
	...
	@Test
	public void leTiroUnEMPAUnaUnidadProtossLaMismaPierdeElEscudoYLaNavePierdeEnergia() throws Exception{
		...
		//Le agrego una casa a cada jugador para que pueda asignarle las unidades
	...
	@Test
	public void tiroUnaEMPYLasUnidadesConEnergiaCercanasLaPierden() throws Exception{
		Mapa mapa = new Mapa("mapaTierra.txt");
		Jugador jugador = new Jugador("Damian", mapa);
		Jugador jugador2 = new Jugador("Luciano", mapa);
	...
	@Test
	public void tiroUnEMPYLasUnidadesFueraDeRangoNoSufrenModificaciones() throws Exception{
		Mapa mapa = new Mapa("mapaTierra.txt");
		Jugador jugador = new Jugador("Damian", mapa);
		Jugador jugador2 = new Jugador("Luciano", mapa);
		Atacable zealot = new Zealot();
	...
	@Test
	public void laTormentaPsionicaLeHaceDanioATodasLasUnidadesHostilesEnElArea() throws Exception{
		Mapa mapa = new Mapa("mapaTierra.txt");
		Jugador jugador = new Jugador("Damian", mapa);
		...
		TormentaPsionica tormenta = new TormentaPsionica(otroJugador,mapa,new Coordenada(3,3));
		tormenta.pasarTurno();
	...
	@Test
	public void lasIlusionesSoloTienenVidaYNoEscudo() throws Exception, EnergiaInsuficiente {
